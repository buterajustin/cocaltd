	...
	<section class="section full-width-bg gray-bg">
		...
		<div class="<?php echo esc_attr($sidebar_class); ?>">
			...
			<div class="blog-post-single <?php echo esc_attr($full_class); ?>">
				...
				<?php if(get_option('sense_show_author_single') != '_hide') { ?>
					<div class="post-meta animate-onscroll">
						<span><?php _e( 'by', MAD_BASE_TEXTDOMAIN ); ?> <?php the_author_posts_link(); ?></span>
						<span><?php _e( 'in', MAD_BASE_TEXTDOMAIN ); ?> <?php echo get_the_category_list( ', ', 'multiple', $post_id ); ?></span>
					</div>
				<?php } ?>
						...
						<tr>
							<td class="share-media">
								<ul class="social-share">	
									<li><?php _e( 'Share this', MAD_BASE_TEXTDOMAIN ); ?>:</li>
							...
							<td class="tags"><?php _e( 'Tags', MAD_BASE_TEXTDOMAIN ); ?>: <?php echo get_the_tag_list( '', ', ' ); ?></td>
						</tr>
				...
				<div class="row animate-onscroll">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 button-pagination align-left">
						<?php  previous_post_link( '%link', __( 'Prev post', MAD_BASE_TEXTDOMAIN ) );  ?>
					</div>
					
					<div class="col-lg-6 col-md-6 col-sm-6 button-pagination align-right">
						<?php  next_post_link( '%link', __( 'Next post', MAD_BASE_TEXTDOMAIN ) ); ?>
					</div>
				...
				<div class="post-author animate-onscroll">
					...
					<h4><?php printf( esc_attr__( 'About %s', MAD_BASE_TEXTDOMAIN ), get_the_author() ); ?></h4>
			...
			<div class="related-articles">
				...
				<h3 class="animate-onscroll"><?php _e( 'Related Articles', MAD_BASE_TEXTDOMAIN ); ?></h3>
			...
			<!-- Post Comments -->
			<div class="post-comments">
				<h3 class="animate-onscroll"><?php _e( 'Comments', MAD_BASE_TEXTDOMAIN ); ?></h3>
				<ul id="comments">
			...
			<h3 class="animate-onscroll"><?php _e( 'Leave a reply', MAD_BASE_TEXTDOMAIN ); ?></h3>
			<p class="animate-onscroll"><?php _e( 'Your email address will not be published. Fields marked * are mandatory.', MAD_BASE_TEXTDOMAIN ); ?></p>
			
			<?php
				$comment_field = '<div class="col-lg-12 col-md-12 col-sm-12"><label>'. __( 'Comment*', MAD_BASE_TEXTDOMAIN ) .'</label>
								<textarea  rows="10" name="comment" ></textarea>
								</div>';
				$fields =  array(
				'author' => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'Name*', MAD_BASE_TEXTDOMAIN ) .'</label>
							<input type="text" name="author" value="" >
							</div>',  
				'email'  => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'E-mail*', MAD_BASE_TEXTDOMAIN ) .'</label>
							<input type="email" name="email" value="" >
							</div>',  
				'url'    => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'Website', MAD_BASE_TEXTDOMAIN ) .'</label>
				...
				$comments_args = array(
						...
						'label_submit' => '',
						'title_reply' => '',  
						'title_reply_to' => __( '<h4 style="margin-top:0; margin-bottom:10px;" >Leave a Reply to %s</h4>', MAD_BASE_TEXTDOMAIN ),   
						'cancel_reply_link' => __( '<h4 style="margin-top:0; margin-bottom:5px;" >Cancel reply</h4>', MAD_BASE_TEXTDOMAIN ),  					
						'comment_field' => $comment_field,
						'comment_notes_before' => '',
						'comment_notes_after'=>'<input type="submit" name="submit" value="'. __( 'Post Comment', MAD_BASE_TEXTDOMAIN ) .'">'
						);
