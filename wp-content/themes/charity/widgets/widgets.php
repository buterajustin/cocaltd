...
class Candidat_WP_Widget_Calendar extends WP_Widget {
	...
	function Candidat_WP_Widget_Calendar() {
		...
		parent::__construct( 'widget_calendar_custom', THEMENAME.' - '.__('Custom Calendar', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_Banner_Icon_Widget extends WP_Widget {
	...
	function Candidat_Banner_Icon_Widget() {
		...
		parent::__construct( 'widget_banner_icon', THEMENAME.' - '.__('Banner Icon', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_Banner_Donate_Widget extends WP_Widget {
	...
	function Candidat_Banner_Donate_Widget() {
		...
		parent::__construct( 'widget_banner_donate', THEMENAME.' - '.__('Banner Donate', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_WP_Widget_Social extends WP_Widget {
	...
	function Candidat_WP_Widget_Social() {
		...
		parent::__construct( 'widget_social', THEMENAME.' - '.__('Social widget', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_Featured_Video_Widget extends WP_Widget {
	...
	function Candidat_Featured_Video_Widget() {
		...
		parent::__construct( 'widget_featured_video', THEMENAME.' - '.__('Featured Video', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_Banner_Img_Widget extends WP_Widget {
	...
	function Candidat_Banner_Img_Widget() {
		...
		parent::__construct( 'widget_banner_img', THEMENAME.' - '.__('Banner', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_My_Flickr_Widget extends WP_Widget {
	...
	function Candidat_My_Flickr_Widget() {
		...
		parent::__construct( 'widget_flickr_img', THEMENAME.' - '.__('Flickr images', THEMENAME), $widget_ops, $control_ops );
	}
...
class Candidat_Instagram_Widget extends WP_Widget {
	...
	function Candidat_Instagram_Widget() {
		...
		parent::__construct( 'widget_instagram', THEMENAME.' - '.__('INSTAGRAM PHOTOS', THEMENAME), $widget_ops, $control_ops );
	}
