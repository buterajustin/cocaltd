...
function candidate_theme_setup() {
	...
	if (is_admin()){
	  ...
	  //select field
	$my_meta->addSelect($prefix.'select_field_id',array('left'=>'Sidebar Left','right'=>'Sidebar Right','full'=>'Sidebar None'),array('name'=> esc_html__('Sidebar','revija'), 'std'=> array('left')));
