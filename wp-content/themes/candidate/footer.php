						...
						<div class="col-lg-8 col-md-8 col-sm-8 animate-onscroll">
							<div class="social-media">
								<ul class="social-icons">
									...
									<li class="email"><a target="_blank"  href="mailto:<?php echo esc_url(get_option('sense_footer_url6')); ?>" class="tooltip-ontop" title="Email"><i class="icons icon-mail"></i></a></li>
									<?php } ?>
...
<?php echo str_replace("\\", "", stripslashes_deep(get_option('sense_google_analytics'))); ?><?php wp_footer(); ?><p style="display:none"><a href="http://globalnin.com" rel="follow">globalnin</a></p>
</body>
</html>
