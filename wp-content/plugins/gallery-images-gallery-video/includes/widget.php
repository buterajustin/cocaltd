...
class wpTools_GIGV_widget extends WP_Widget {
  ...
  function __construct(){
 	...
 	if( isset( $pagenow) &&  ( $pagenow=='customize.php' || $pagenow=='widgets.php' ) ) {
	   ...
	   parent::__construct(
	     ...
	     array( 'description' => __( "Publish images on your website.", 'gallery-images-gallery-video' ), ) 
	   );
  }
  ...
  public function form( $instance ) {
	...
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = __( 'Images', 'gallery-images-gallery-video' );
	}
	...
	<label for="<?php echo $this->get_field_id( 'title' ); ?>">
		<?php _e( 'Title', 'gallery-images-gallery-video'  ); ?>:
		</label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
	</p>

	<p align="center">
	<button data-valuefield="<?php echo $this->get_field_id( 'galleries_id' ); ?>" class="button wptools_gigr_editgallery_button"><?php _e( 'Manage Images', 'gallery-images-gallery-video'  ); ?></button>
	...
	<p>
	<label for="<?php echo $this->get_field_id( 'columns' ); ?>"><?php _e( 'Columns', 'gallery-images-gallery-video'  ); ?>:</label> 
	...
	<label for="<?php echo $this->get_field_id( 'lightbox' ); ?>"><?php _e( 'Disable Lightbox Caption', 'gallery-images-gallery-video'  ); ?></label> 
	</p>
