				...
				<div id="misc-publishing-actions">
					<div class="misc-pub-section">
						<span id="plugin-home" class="icon">
							<strong><a href="http://mypgc.co/" style="text-decoration: none;"><?php _e('Plugin Home','flash-album-gallery'); ?></a></strong>
						</span>
					</div>
					<div class="misc-pub-section">
					...
					<div class="misc-pub-section curtime misc-pub-section-last">
						<span id="contact-me" class="icon">
							<a href="http://mypgc.co/contact/" style="text-decoration: none;"><?php _e('Contact Me','flash-album-gallery'); ?></a>
						</span>
					</div>
				</div>
			</div>
