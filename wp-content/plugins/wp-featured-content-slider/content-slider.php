...
<div id="featured_slider">
	...
	<ul id="slider">
		...
		<li><div class="content_left"><h2><a href="<?php the_permalink();?>"><?php the_title();?></a></h2><?php echo c_slider_cut_text(get_the_content(), $c_slider_limit, $c_slider_points);?><br><h3><a href="<?php the_permalink();?>">Read More</a></h3></div><div class="img_right"><a href="<?php the_permalink();?>"><img src="<?php echo $c_slider_thumb;?>" class="img-responsive" /></a></div></li>
...
<!--<p class="<?php //echo $c_slider_class;?>">Slider by <a href="http://hirwa.herokuapp.com" target="_blank" title="Webdesign by Hirwa">Hirwa</a></p>-->